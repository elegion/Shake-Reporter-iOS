#
#  Be sure to run `pod spec lint ELFeedback.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "ELFeedback"
  s.version      = "0.0.1"
  s.summary      = "A short description of ELFeedback."

  s.description  = <<-DESC
                   A longer description of ELFeedback in Markdown format.
